...
One go my favourite aspects of Python as a programming language is list comprehensions, which are succinct and expressive ways of creating Python lists. Traditional for loops can be used for the same purpose, but list comprehensions are generally more efficient and preferred for several reasons. In this article, I attempt to dissect why list comprehensions are superior to traditional loops.
...
This is synonymous to speed in analyzing algorithms Let's check the performance using timeit. 
