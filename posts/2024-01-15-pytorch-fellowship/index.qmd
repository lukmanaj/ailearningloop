...
The fellowship's curriculum is centered around the comprehensive PyTorch deep learning book, a resource that's freely available and highly recommended for enthusiasts in the field (find it here: [PyTorch Deep Learning by Daniel Bourke](https://github.com/mrdbourke/pytorch-deep-learning)).
